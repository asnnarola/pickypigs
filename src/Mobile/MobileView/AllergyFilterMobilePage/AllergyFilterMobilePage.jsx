        ...
        <section style={{marginTop:90}}>
            <div className="container" style={{position:'relative'}}>
                <div className="d-flex justify-content-between align-items-center">
                    <div>
                        <h4>Filters{JSON.stringify(checkValue) }{alergy}</h4>

                    </div>
                    <div>
                        <input  type="checkbox" className="mr-1" onChange={(e)=>{setCheckValue(e.target.checked)}}/>
                ...
                <div className="accordion" id="accordionExample1">
                    <div className="border-bottom  pb-3 mb-3">
                        <div className="p-0" id="headingOne">
                            <div className="mb-0">
                                <button  className="btn btn-block text-left d-flex justify-content-between pl-0 pr-0 mb-3" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                ...
                <div className="accordion" id="accordionExample2">
                    <div className="border-bottom pb-3 mb-3">
                        <div className="p-0" id="headingTwo">
                            <div className="mb-0">
                                <button  className="btn btn-block text-left d-flex justify-content-between pl-0 pr-0 mb-3" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                                     DIETARY PREFERENCES
                                    <div className="accordian-arrow ml-auto">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14.063" height="8.031" viewBox="0 0 14.063 8.031">
                                            <path id="Path_389" data-name="Path 389" d="M-7-4.687h0l5.438-5.219a.313.313,0,0,1,.5,0l.969.938a.313.313,0,0,1,0,.5L-6.75-2.094A.338.338,0,0,1-7-2a.338.338,0,0,1-.25-.094l-6.656-6.375a.312.312,0,0,1,0-.5l.969-.937a.313.313,0,0,1,.5,0Z" transform="translate(14.031 10.031)" fill="#232323" />
                ...
                <div className="accordion" id="accordionExample3">
                    <div className="border-bottom pb-3 mb-3">
                        <div className="p-0" id="headingThree">
                            <div className="mb-0">
                                <button  className="btn btn-block text-left d-flex justify-content-between pl-0 pr-0 mb-3" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
                                     DIETARY PREFERENCES
                                    <div className="accordian-arrow ml-auto">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14.063" height="8.031" viewBox="0 0 14.063 8.031">
                                            <path id="Path_389" data-name="Path 389" d="M-7-4.687h0l5.438-5.219a.313.313,0,0,1,.5,0l.969.938a.313.313,0,0,1,0,.5L-6.75-2.094A.338.338,0,0,1-7-2a.338.338,0,0,1-.25-.094l-6.656-6.375a.312.312,0,0,1,0-.5l.969-.937a.313.313,0,0,1,.5,0Z" transform="translate(14.031 10.031)" fill="#232323" />
                ...
                <div className="accordion" id="accordionExample4">
                    <div className="border-bottom pb-3 mb-3">
                        <div className="p-0" id="headingFour">
                            <div className="mb-0">
                                <button  className="btn btn-block text-left d-flex justify-content-between pl-0 pr-0 mb-3" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="true" aria-controls="collapseFour">
                                 RESTAURANT FEATURES
                                    <div className="accordian-arrow ml-auto">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14.063" height="8.031" viewBox="0 0 14.063 8.031">
                                            <path id="Path_389" data-name="Path 389" d="M-7-4.687h0l5.438-5.219a.313.313,0,0,1,.5,0l.969.938a.313.313,0,0,1,0,.5L-6.75-2.094A.338.338,0,0,1-7-2a.338.338,0,0,1-.25-.094l-6.656-6.375a.312.312,0,0,1,0-.5l.969-.937a.313.313,0,0,1,.5,0Z" transform="translate(14.031 10.031)" fill="#232323" />
                ...
                <div className="accordion" id="accordionExample5">
                    <div className=" pb-3 mb-3">
                        <div className="p-0" id="headingFive">
                            <div className="mb-0">
                                <button  className="btn btn-block text-left d-flex justify-content-between pl-0 pr-0 mb-3" type="button" data-toggle="collapse" data-target="#collapseFive" aria-expanded="true" aria-controls="collapseFive">
                                 RESTAURANT DISTANCE
                                    <div className="accordian-arrow ml-auto">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14.063" height="8.031" viewBox="0 0 14.063 8.031">
                                            <path id="Path_389" data-name="Path 389" d="M-7-4.687h0l5.438-5.219a.313.313,0,0,1,.5,0l.969.938a.313.313,0,0,1,0,.5L-6.75-2.094A.338.338,0,0,1-7-2a.338.338,0,0,1-.25-.094l-6.656-6.375a.312.312,0,0,1,0-.5l.969-.937a.313.313,0,0,1,.5,0Z" transform="translate(14.031 10.031)" fill="#232323" />
