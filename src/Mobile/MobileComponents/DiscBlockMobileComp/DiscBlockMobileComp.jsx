...
import "./DiscBlockMobileComp.scss"
import restaurant_P1 from "../../../assets/images/restaurant/r1.png"


const DiscBlockMobileComp = ({ restaurant_Pic = { restaurant_P1}, kmValue, rating,scale}) => {
    return (
            <div className="restaurantDiscBlockMobile-wrapper mb-4 pb-2">
                <div className={`${scale}`}>
...
export default DiscBlockMobileComp
