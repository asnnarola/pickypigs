...
const MenuBlockMobileComp = ({ restaurant_Pic = { restaurant_P1}, kmValue, rating}) => {
    return (
                    ...
                    <div className="restaurant-img position-relative">
                        ...
                        <div className="restaurant-details brandon-Medium">
                            <div className="d-flex justify-content-between align-items-baseline">
                                <p className="mb-2 text-white">The Barrio Brothers Express</p>
                            ...
                            <p className="txt-lightgray f-14 d-flex flex-wrap align-items-center mb-2 text-white">
