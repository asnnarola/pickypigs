...
import {showSignUpPopup} from '../../../redux/actions/generalActions'
...
const Header = (props) => {
    ...
    const loginModal = useSelector((state) => state.general.showSignUpPopup);
    useEffect(() => {
        setShowSignUp(loginModal);
      },[loginModal])
            ...
            <Navbar.Collapse id="basic-navbar-nav" className="menu-list">
                ...
                <Modal centered show={showSignUp} onHide={handleCloseSignUp} className="signup-modal">
                    <Modal.Body className="p-0 position-relative">
                        <Signup  
                            gotoLogin={() => {dispatch(showSignUpPopup(false));setShowLogIn(true);}} 
                ...
                <Modal centered show={showLogIn} onHide={handleCloseLogIn} className="SignInPage-modal">
                    <Modal.Body className="p-0 position-relative">
                        <SignInPage 
                            ...
                            handleClose={handleCloseLogIn} show={showLogIn} 
                        />
                    </Modal.Body>
                </Modal>
