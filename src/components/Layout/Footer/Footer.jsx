                ...
                <div className="row pl-lg-4">
                    <div className="col-sm-12 col-md-6 col-lg-3 col-xl-3">
                        <div className="footer-block">
                            ...
                            <ul className="pl-0">
                                <li className="li-list f-15 mb-2">Team</li>
                                <li className="li-list f-15 mb-2">Careers</li>
                                <li className="li-list f-15 mb-2">Blog</li>
                            </ul>
                        </div>
                    </div>
                    <div className="col-sm-12 col-md-6 col-lg-3 col-xl-3">
                        <div className="footer-block">
                            <p className="f-15 brandon-Medium">Terms & Conditions</p>
                            <ul className="pl-0">
                                <li className="li-list f-15 mb-2">Privacy</li>
                                <li className="li-list f-15 mb-2">Cookies</li>
                                <li className="li-list f-15 mb-2">All Terms</li>
                            </ul>
                        </div>
                    </div>
                    <div className="col-sm-12 col-md-6 col-lg-3 col-xl-3">
                    ...
                    <div className="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div className="footer-block mb-3">
                            <p className="f-15 brandon-Medium">Contact us</p>
                            <ul className="pl-0 d-flex flex-wrap">
                                <li className="li-list f-15 mb-2 mr-5">
                                    <p className="mb-1">Partnership:</p>
                                    <p>contact@nareshbingi.com</p>
                                </li>
                                <li className="li-list f-15 mb-2">
                                    <p className="mb-1">General inquiries:</p>
                                    <p>hello@nareshbingi.com</p>
                                </li>
                            </ul>
                        </div>
                    </div>
